...
import com.lightningstudio.watchrss.phone.privacy.initialPhoneOobeConsentState
import com.lightningstudio.watchrss.phone.privacy.phoneOobeStage
...
/** Essential first-run flow. The extended feature tour is intentionally disabled. */
class PhoneOobeActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            WatchRssPhoneTheme {
                ...
                var hasConsent by remember {
                    mutableStateOf(
                        initialPhoneOobeConsentState(
                            hasRequiredConsent = consentStore.hasRequiredConsent(),
    ...
    companion object {
        private const val EXTRA_REPLAY_FROM_START = "replay_from_start"

        fun createIntent(context: Context, replayFromStart: Boolean = false): Intent =
            Intent(context, PhoneOobeActivity::class.java).apply {
                putExtra(EXTRA_REPLAY_FROM_START, replayFromStart)
            }
    }
}
