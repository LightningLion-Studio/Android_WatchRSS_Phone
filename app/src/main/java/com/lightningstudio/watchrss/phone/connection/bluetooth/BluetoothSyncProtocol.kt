...
object BluetoothSyncProtocol {
    ...
    const val ACTION_CLEAR_LIBRARY = "clearLibrary"
    const val LIBRARY_MODE_MERGE = "merge"
    const val LIBRARY_MODE_PHONE_TO_WATCH_REPLACE = "phoneToWatchReplace"
    const val LIBRARY_MODE_WATCH_TO_PHONE_REPLACE = "watchToPhoneReplace"
    ...
    const val ACTION_PULL_DEBUG_LOG = "pullDebugLog"
